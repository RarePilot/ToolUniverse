...
if not _LIGHT_IMPORT and not LAZY_LOADING_ENABLED:
    ...
    from .hpo_normalization_tool import HPONormalizationTool
    ...
    HPONormalizationTool = _LazyImportProxy(
        "hpo_normalization_tool", "HPONormalizationTool"
    )
